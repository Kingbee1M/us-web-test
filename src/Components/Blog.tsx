...
const Blog = () => {
    ...
    return (
        <article className="bg-white w-full h-auto flex flex-col items-center relative pb-32">
            ...
            <div className='mt-32 w-full flex flex-col items-center gap-4'>
                <h2 className="font-garamond text-center text-2xl lg:text-4xl font-semibold">Let&apos;s Build a Smarter Customer Experience</h2>
