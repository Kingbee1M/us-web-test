...
const CoreSolutions = () => {
    const cores = [
        ...
        {id: 4, value: false, title: 'Specialized Industry Solutions', subtitle: 'Tailored Expertise for Every Sector.', desc: 'Sector-specific outsourcing combining domain expertise with AI intelligence.', offers: [], impacts: '', industries: {'E-Commerce & Retail': 'Omnichannel support, order management, cart recovery.', 'Healthcare & HealthTech': '  Non-clinical patient engagement and medical device support.', 'Fintech & Financial Services': ' KYC, compliance, transaction support', 'Telecom & Media': 'Retention, upsell, technical support', 'Travel & Hospitality': ' Reservations and disruption management', 'Utilities & Energy': 'Billing support and outage communication.', 'Education & EdTech': ' Enrollment and helpdesk support', 'Result': ' Industry-aligned efficiency and trusted customer experiences'}}
    ]
