const ContactHeader = () => {
    return (
        <header className="w-full flex flex-col items-center gap-3 py-6">
            <h1 className="w-full lg:w-2/5 text-2xl md:text-3xl lg:text-3xl xl:text-4xl font-garamond font-bold text-cente text-heading-color text-center">Let&apos;s Build Something Exceptional Together</h1>
