...
const ClearValue = () => {
    ...
    const values: ValueItem[] = [
        ...
        {icon: img3, color: '#78e9d5', title: 'Fintech & Financial Services', desc: {'What We Do': ['KYC, onboarding, verification, anti-fraud checks', 'Customer support for cards, wallets, loans.', 'Dispute resolution and transaction assistance.'], 'Value Delivered': ['High compliance accuracy.', 'Reduced fraud-related workload.', 'Lower operational expense with secure offshore teams.']}},
