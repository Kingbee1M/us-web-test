...
import { useState, useEffect } from "react";
    ...
    const heroData =[
        ...
        "With over 19 years of global outsourcing experience, Outcess has evolved from its African roots into a global player with a U.S. presence and delivery centers across Africa. Our mission is simple: to help brands scale smarter, connect deeper, and operate more efficiently through intelligent outsourcing."
    ]
