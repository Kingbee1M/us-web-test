...
const ServiceHeader = () => {
    return (
            <header className="flex flex-col items-center w-full gap-5 mt-6">
                ...
                <p className="lg:text-base text-sm w-[80%] sm:w-[60%] md:w-auto text-center text-pretty text-text-color font-montserrat leading-7">At Outcess US, we don&apos;t just outsource, we engineer intelligent experiences.<br/>
                ...
                <Button variant="primary" className="mt-7">Work With Us</Button>
            </header>
    )
}
